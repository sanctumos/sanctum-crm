 ...
 * 
 * Provides functionality to enrich person data with company information
...
class PersonEnrich
{
    ...
    /**
     * Execute the enrich lookup
     *
     * @return EnrichResponse
     */
    public function enrich(): EnrichResponse
    {
        $data = $this->httpClient->get('/person/lookup', $this->query->toArray());
        return new EnrichResponse($data);
    }
}
