                                        ...
                                        <table class="table table-hover mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-info"><?php echo ucfirst($deal['stage']); ?></span>
                                                    </td>
                                                    <td>
                                                        <small class="text-muted">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <a href="/index.php?page=contacts&action=add" class="btn btn-primary btn-action w-100">
                                                <i class="fas fa-user-plus me-2"></i>Add Contact
                                            </a>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <a href="/index.php?page=deals&action=add" class="btn btn-success btn-action w-100">
                                                <i class="fas fa-handshake me-2"></i>Create Deal
                                            </a>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <a href="/index.php?page=contacts&type=lead" class="btn btn-warning btn-action w-100">
                                                <i class="fas fa-list me-2"></i>View Leads
                                            </a>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <a href="/index.php?page=reports" class="btn btn-info btn-action w-100">
